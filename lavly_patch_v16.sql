-- =========================================================================
-- V16: COMPLEMENTO - FÓRMULA DE TICKET MÉDIO (FATURAMENTO / CLIENTE)
-- =========================================================================

-- Redefine a Função Principal para adotar o cálculo correto do Ticket Médio 
...
BEGIN
    ...
    SELECT json_build_object(
        ...
        'salesMetrics', json_build_object(
            ...
            -- [CORREÇÃO DO BUG]: Ticket Médio = Faturamento BRUTO dividido pelo NÚMERO DE CLIENTES ÚNICOS, não transações.
            'averageTicket', CASE
