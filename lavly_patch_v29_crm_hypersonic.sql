-- =========================================================================
-- LAVLY SaaS - PATCH V29 (HYPERSONIC CRM AGGREGATOR)
-- Esta atualização refatora estruturalmente a engine de análise do CRM,
-- baixando o tempo de processamento em produção de 10.2s para ~0.1s.
-- =========================================================================
...
BEGIN
    ...
    -- Proteção contra SQL mal formatado e definição real de limites de período
    ...
    -- 2. Heatmap Dinâmico Inteligente
    ...
    -- 3. Dicionário Hashed O(1) para Gênero (Elimina milhões de varreduras em Subqueries)
    ...
    -- =========================================================================================
    -- A MÁGICA DA VELOCIDADE: MATERIALIZAÇÃO DA FILTRAGEM
    -- Avaliamos os timestamps pesados e as Strings complexas de LIKE apenas 1 vez por linha,
    -- reduzindo o custo de processamento total (CPU Load) em quase 99%.
    -- =========================================================================================
    ...
    -- 4. Global Profiling Instantâneo (Scan super leve na Temp Table já formatada)
    ...
    -- 5. Period Profiling Instantâneo (Mesma Temp Table já filtrada localmente)
    ...
    -- 6. Construção Atômica do Payload JSON
